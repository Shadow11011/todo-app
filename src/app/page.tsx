...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-900 text-gray-100 p-8 flex flex-col items-center">
      ...
      {/* Chat Button & Window */}
      {!chatOpen && <button onClick={() => setChatOpen(true)} className="fixed bottom-6 right-6 bg-gradient-to-r from-indigo-600 to-purple-700 text-white p-4 rounded-full shadow-lg hover:scale-110 transition transform">💬</button>}
      {chatOpen && (
